    ...
    return (
        ...
        <Header title="Sign Up"></Header>
        {
            ...
            <form className="mt-4" onSubmit={handleSubmit}>
                <select className="p-2 border-2 border-zinc-300 dark:border-slate-600 rounded-md w-64 md:w-96" value={role} onChange={(e) => setRole(e.target.value)} required>
                    <option value="" disabled>Select Role</option>
                    <option value="STUDENT">Student</option>
                    <option value="REPRESENTATIVE">Representative</option>
                </select>
                <div className="flex flex-col m-4 w-64 md:w-96">
                    ...
                    <button className="p-2 dark:bg-zinc-600 bg-slate-100 w-64 md:w-96" disabled={emailExists === true}><input type="submit"/></button>
                </div>
